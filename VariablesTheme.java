public class VariablesTheme {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" " + forwardSlash + "" + underscore + "" + underscore + "" +
                ...
                forwardSlash + "" + backSlash + "" + underscore + "" + underscore + "" +
                backSlash + "\n");
        ...
        int hundredNum = srcNum / 100;
        int decimalNum = (srcNum / 10) % 10;
        int singleNum = srcNum % 10;

        int summ = hundredNum + decimalNum + singleNum;
        int multy = hundredNum * decimalNum * singleNum;

        System.out.println("Сумма цифр числа " + srcNum + " равна: " + summ);
        System.out.println("Произведение цифр числа " + srcNum + " равна: " + multy + "\n");
